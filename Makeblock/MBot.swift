...
public class MBot: MakeblockRobot {
    ...
    /**
    Puts some pixels on that robots face
    */
    public func drawImage() {
        sendMessage(.LedMatrix, arrayOfBytes: [MBotPorts.Port4.rawValue, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
        sendMessage(.LedMatrix, arrayOfBytes: [MBotPorts.Port4.rawValue, 0x02, 0x00, 0x00, 0x00, 0x20, 0x50, 0x50, 0x24, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x24, 0x50, 0x50, 0x20, 0x00])
        //sendMessage(.LedMatrix, arrayOfBytes: [MBotPorts.Port4.rawValue, 0x02, 0x00, 0x00, 0x01, 0x02, 0x01, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02, 0x02])
        //sendMessage(.LedMatrix, arrayOfBytes: [MBotPorts.Port4.rawValue, 0x03, 0x01, 0x11, 0x0b])
    }
